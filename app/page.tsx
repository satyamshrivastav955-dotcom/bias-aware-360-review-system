...
export default function Home() {
  ...
  // AppHeader paints from --editorial-*, which globals.css scopes to .app-shell.
  // This page is a .dashboard-shell, so without these the header is transparent.
  return <div className="dashboard-shell flex" style={{ "--editorial-bg": "var(--color-sheet)", "--editorial-surface": "var(--color-sheet)", "--editorial-rule": "var(--color-rule)", "--editorial-text": "var(--color-ink)", "--editorial-muted": "var(--color-graphite)" } as React.CSSProperties}>
    ...
    <main className="min-w-0 flex-1">
      <AppHeader />
      <div className="mx-auto max-w-[1160px] px-5 py-10 md:px-10 md:py-12" id="overview">
